      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              <li><a class="nav-link" href="<?= base_url('admin/dashboard') ?>"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
              ...
              <li><a class="nav-link" href="<?= base_url('admin/data_customer') ?>"><i class="fas fa-user"></i> <span>Data Customer</span></a></li>
              ...
              <li><a class="nav-link" href="<?= base_url('auth/login') ?>"><i class="fas fa-sign-out-alt"></i> <span>Logout</span></a></li>
