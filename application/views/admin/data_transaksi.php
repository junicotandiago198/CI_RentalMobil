<div class="main-content">
    ...
    foreach ($transaksi as $tr) : ?>
        ...
        <td>
            <center><?php if(empty($tr->bukti_pembayaran)) { ?>
            ...
            <td><?php if($tr->status=="1") {
                ...
                <div class="row">
                    ...
                    <a class="btn btn-sm btn-danger" href="<?= base_url('admin/transaksi/transaksi_batal/'.$tr->id_rental) ?>"><i class="fas fa-times"></i></a>
                </div>
           <?php } ?></td>
