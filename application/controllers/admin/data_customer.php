...
class Data_customer extends CI_Controller
{
    ...
    {
    $data['customer'] = $this->rental_model->get_data('tb_customer')->result();
    ...
    public function tambah_customer_aksi()
    {
        ...
        $this->rental_model->insert_data($data,'tb_customer');
    ...
    public function update_customer_aksi()
    {
        ...
        $this->rental_model->update_data('tb_customer',$data,$where);
        $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $where = array ('id_customer' => $id);
        $this->rental_model->delete_data($where,'tb_customer');
